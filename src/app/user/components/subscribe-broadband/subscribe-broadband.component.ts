...
export class SubscribeBroadbandComponent implements OnInit {
  ...
  getBroadBandById() {
    this.customerService.getBroadBandById(this.broadbandId).subscribe((res) => {
  ...
  submitForm(subscribeBroadbandDto: any): void {
    ...
    if (this.validateForm.valid) {
      ...
      this.customerService.subscribeBroadband(this.broadbandId, this.validateForm.value).subscribe((res) => {
